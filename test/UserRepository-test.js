...
describe('UserRepository', function() {
  ...
  it("should have a method that calculates average number of steps for users", function () {
    user1.activityRecord = [
      { date: "2019/09/17", steps: 100 },
      { date: "2019/09/17", steps: 2000 },
    ];
    user2.activityRecord = [
      { date: "2019/09/16", steps: 9820 },
      { date: "2019/09/17", steps: 234 },
    ];
  ...
  it("should have a method that calculates average number of stairs for users", function () {
    user1.activityRecord = [
      { date: "2019/09/17", flightsOfStairs: 10 },
      { date: "2019/09/17", flightsOfStairs: 15 },
    ];
    user2.activityRecord = [
      { date: "2019/09/16", flightsOfStairs: 8 },
      { date: "2019/09/17", flightsOfStairs: 4 },
    ];
  ...
  it("should have a method that calculates average number of active minutes for users", function () {
    user1.activityRecord = [
      { date: "2019/09/17", minutesActive: 100 },
      { date: "2019/09/17", minutesActive: 20 },
    ];
    user2.activityRecord = [
      { date: "2019/09/16", minutesActive: 78 },
      { date: "2019/09/17", minutesActive: 12 },
    ];
    expect(userRepository.calculateAverageMinutesActive("2019/09/17")).to.equal(
      44
    );
  });
  ...
  it('should have a method that finds the worst sleepers', function() {
    ...
    expect(userRepository.getWorstSleepers(sleepData, "2019/06/15")).to.equal(1);
  });
});
